...
PortableServer_POA MateCORBA_POA_new_from (CORBA_ORB                  orb,
...
void MateCORBA_skel_class_register (PortableServer_ClassInfo   *ci,
...
#define MATECORBA_SERVANT_SET_CLASSINFO(servant,ci) G_STMT_START {	       \
...
gboolean                  MateCORBA_poa_allow_cross_thread_call      (MateCORBA_POAObject   pobj,
								  MateCORBA_IMethodFlag method_flags);
void                      MateCORBA_recv_buffer_return_sys_exception (GIOPRecvBuffer    *buf,
								  CORBA_Environment *ev);
