...
void            MateCORBA_ObjectAdaptor_set_thread_hint  (MateCORBA_ObjectAdaptor adaptor,
						      MateCORBAThreadHint     thread_hint,
						      ...);
void            MateCORBA_ObjectAdaptor_set_thread_hintv (MateCORBA_ObjectAdaptor adaptor,
						      MateCORBAThreadHint     thread_hint,
						      va_list             args);
...
void                MateCORBA_OAObject_invoke           (MateCORBA_OAObject     adaptor_obj,
						     gpointer           ret,
						     gpointer          *args,
						     CORBA_Context      ctx,
						     gpointer           data,
...
typedef void                (*MateCORBAInvokeFunc)     (MateCORBA_OAObject     adaptor_obj,
						    gpointer           ret,
						    gpointer          *args,
						    CORBA_Context      ctx,
						    gpointer           data, 
...
typedef void (*MateCORBAReqHandlerFunc) (MateCORBA_ObjectAdaptor         adaptor,
				     GIOPRecvBuffer             *recv_buffer,
