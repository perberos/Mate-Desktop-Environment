                     ...
                     char      **autostart_dirs)
{
        ...
        default_apps = mateconf_client_get_list (client,
                                              default_session_key,
...
append_required_apps (GsmManager *manager)
{
        ...
        client = mateconf_client_get_default ();
        required_components = mateconf_client_get_list (client,
                                                     GSM_MATECONF_REQUIRED_COMPONENTS_LIST_KEY,
                                                     MATECONF_VALUE_STRING,
                                                     NULL);
        ...
        for (r = required_components; r != NULL; r = r->next) {
                ...
                path = g_strdup_printf ("%s/%s",
                                        GSM_MATECONF_REQUIRED_COMPONENTS_DIRECTORY,
                                        component);
...
main (int argc, char **argv)
{
        ...
        gtk_init_with_args (&argc, &argv,
                            (char *) _(" - the MATE session manager"),
