...
static GSList *
gdm_recent_option_widget_get_list_from_mateconf (GdmRecentOptionWidget *widget)
{
        MateConfValue *value;
        GSList     *value_list;
        GSList     *list;
...
static void
gdm_recent_option_widget_sync_items_from_mateconf (GdmRecentOptionWidget *widget)
{
        GSList     *list;
        GSList     *tmp;
        gboolean    default_is_set;

        list = gdm_recent_option_widget_get_list_from_mateconf (widget);
...
static void
gdm_recent_option_widget_notify_func (MateConfClient *client,
                                      guint        connection_id,
                                      MateConfEntry  *entry,
                                      gpointer     user_data)
{
        gdm_recent_option_widget_sync_items_from_mateconf (GDM_RECENT_OPTION_WIDGET (user_data));
}

gboolean
gdm_recent_option_widget_set_mateconf_key (GdmRecentOptionWidget          *widget,
                                        ...
                                        GError                        **error)
{
        ...
        gdm_recent_option_widget_sync_items_from_mateconf (widget);
