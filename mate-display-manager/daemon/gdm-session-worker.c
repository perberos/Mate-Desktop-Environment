...
#define GDM_SESSION_DBUS_PATH         "/org/mate/DisplayManager/Session"
#define GDM_SESSION_DBUS_INTERFACE    "org.mate.DisplayManager.Session"
#define GDM_SESSION_DBUS_ERROR_CANCEL "org.mate.DisplayManager.Session.Error.Cancel"
...
gdm_session_worker_cache_userfiles (GdmSessionWorker *worker)
{
        ...
        if (!res) {
                ...
                g_debug ("Checking user's ~/.mate/gdm file");
