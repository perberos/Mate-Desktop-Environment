...
#define GDM_CHOOSER_SERVER_DBUS_PATH      "/org/mate/DisplayManager/ChooserServer"
#define GDM_CHOOSER_SERVER_DBUS_INTERFACE "org.mate.DisplayManager.ChooserServer"
