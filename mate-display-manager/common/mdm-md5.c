 ...
 *
 * mdm-md5.c md5 implementation (based on L Peter Deutsch implementation)
 *
...
/* This MDM version was modified for glib from dbus-md5.c */
...
/**
 * @defgroup MdmMD5Internals MD5 implementation details
 * @ingroup  MdmInternals
...
static void
md5_process (MdmMD5Context *context,
...
static void
md5_init (MdmMD5Context *context)
{
...
static void
md5_append (MdmMD5Context       *context,
...
static void
md5_finish (MdmMD5Context *context,
 ...
 */
void
mdm_md5_init (MdmMD5Context *context)
{
        md5_init (context);
}
 ...
 */
void
mdm_md5_update (MdmMD5Context *context,
                const GString *data)
{
 ...
 */
gboolean
mdm_md5_final (MdmMD5Context *context,
               GString       *results)
{
        unsigned char digest[16];
         ...
         */
        memset ((void*)context, '\0', sizeof (MdmMD5Context));
