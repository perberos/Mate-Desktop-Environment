...
MATE_CLASS_BOILERPLATE (MateAbout, mate_about,
			 GtkDialog, GTK_TYPE_DIALOG)

static void
mate_about_update_authors_label (MateAbout *about, GtkWidget *label)
{
	GString *string;
	GSList *list;
	gchar *tmp;
...
static void
mate_about_update_documenters_label (MateAbout *about, GtkWidget *label)
{
	GString *string;
	GSList *list;
	gchar *tmp;
...
static void
mate_about_update_translation_information_label (MateAbout *about, GtkWidget *label)
{
	GString *string;
	gchar *tmp;
...
static void
mate_about_display_credits_dialog (MateAbout *about)
{
...
static void
mate_about_instance_init (MateAbout *about)
{
...
static void
mate_about_response (GtkDialog *dialog, gint response)
{
	switch (response) {
...
static void
mate_about_class_init (MateAboutClass *klass)
{
...
static void
mate_about_set_comments (MateAbout *about, const gchar *comments)
{
...
static void
mate_about_set_translator_credits (MateAbout *about, const gchar *translator_credits)
{
...
static void
mate_about_set_copyright (MateAbout *about, const gchar *copyright)
{
...
static void
mate_about_set_version (MateAbout *about, const gchar *version)
{
...
static void
mate_about_set_name (MateAbout *about, const gchar *name)
{
	gchar *title_string;
	gchar *name_string;
...
static void
mate_about_free_person_list (GSList *list)
{
	if (list == NULL)
		return;
...
static void
mate_about_finalize (GObject *object)
{
...
static void
mate_about_set_persons (MateAbout *about, guint prop_id, const GValue *persons)
{
...
static void
mate_about_set_property (GObject *object, guint prop_id, const GValue *value, GParamSpec *pspec)
{
	switch (prop_id) {
	case PROP_NAME:
...
static void
mate_about_get_property (GObject *object, guint prop_id, GValue *value, GParamSpec *pspec)
{
	MateAbout *about;
 ...
 */
GtkWidget *
mate_about_new (const gchar  *name,
		 const gchar  *version,
 ...
 */
void
mate_about_construct (MateAbout *about,
		       const gchar  *name,
		       const gchar  *version,
		       const gchar  *copyright,
		       const gchar  *comments,
