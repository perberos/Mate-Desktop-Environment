...
#ifndef __MATE_I18N_H__
#define __MATE_I18N_H__

#ifndef MATE_DISABLE_DEPRECATED

#include <glib.h>
#ifdef MATE_EXPLICIT_TRANSLATION_DOMAIN
#  define MATECOMPONENT_EXPLICIT_TRANSLATION_DOMAIN MATE_EXPLICIT_TRANSLATION_DOMAIN
#endif
 ...
 * LANG="de_DE:de:C:en"
 *
 * In this case 'mate_i18n_get_language_list ("LC_COLLATE")' returns the
 * list: ("de_DE" "de" "C" "en").
 *
 * 'mate_i18n_get_language_list ("LC_MONETARY")' returns:
 * ("de_DE" "es" "C")
 *
