 ...
 **/
int
mate_execute_async_with_env_fds (const char *dir, int argc, 
 ...
 **/
int
mate_execute_async_with_env (const char *dir, int argc, char * const argv[], 
 ...
 **/
int
mate_execute_async (const char *dir, int argc, char * const argv[])
{
 ...
 **/
int
mate_execute_async_fds (const char *dir, int argc, 
			 char * const argv[], gboolean close_fds)
{
  return mate_execute_async_with_env_fds (dir, argc, argv, 0, NULL, 
					   close_fds);
}
 ...
 **/
int
mate_execute_shell_fds (const char *dir, const char *commandline,
			 gboolean close_fds)
{
  char *user_shell;
  char * argv[4];
 ...
 **/
int
mate_execute_shell (const char *dir, const char *commandline)
{
 ...
 **/
void
mate_prepend_terminal_to_vector (int *argc, char ***argv)
{
#ifndef G_OS_WIN32
        char **real_argv;
        int real_argc;
 ...
 **/
int
mate_execute_terminal_shell_fds (const char *dir, const char *commandline,
				  gboolean close_fds)
{
	char ** argv;
	int argc;
	...
	r = mate_execute_async_with_env_fds (dir, argc, argv, 0, NULL,
					      close_fds);
 ...
 **/
int
mate_execute_terminal_shell (const char *dir, const char *commandline)
{
