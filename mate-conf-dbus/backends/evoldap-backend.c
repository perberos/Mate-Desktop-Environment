...
typedef struct
{
  ...
  MateConfValue *accounts_value;
  MateConfValue *addressbook_value;
  MateConfValue *calendar_value;
  MateConfValue *tasks_value;
...
static MateConfBackendVTable evoldap_vtable = {
...
/*
 * Copied from mateconf/mateconf-internals.c
 */
static char *
		 ...
		 GError    **err)
{
  ...
  if (template == NULL)
    {
      mateconf_log (GCL_ERR, _("No <template> specified in '%s'"), esource->conf_file);
      return TRUE;
    }
  ...
  while (entry != NULL)
    {
      ...
      mateconf_value_set_string_nocopy (value, str);
  ...
  if (values != NULL)
    {
      ...
      mateconf_value_set_list_type (retval, MATECONF_VALUE_STRING);
      mateconf_value_set_list_nocopy (retval, values);
    }
		      ...
		      GError    **err)
{
  ...
  return esource->accounts_value ? mateconf_value_copy (esource->accounts_value) : NULL;
}
			 ...
			 GError    **err)
{
  ...
  return esource->addressbook_value ? mateconf_value_copy (esource->addressbook_value) : NULL;
}
		      ...
		      GError    **err)
{
  ...
  return esource->calendar_value ? mateconf_value_copy (esource->calendar_value) : NULL;
}
		   ...
		   GError    **err)
{
  ...
  return esource->tasks_value ? mateconf_value_copy (esource->tasks_value) : NULL;
}
	     ...
	     GError      **err)
{
  ...
  return retval != NULL ? mateconf_value_copy (retval) : NULL;
}
	     ...
	     GError      **err)
{
  ...
  return value ? g_slist_append (NULL, mateconf_entry_new (key, value)) : NULL;
}
