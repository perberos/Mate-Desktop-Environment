...
/* LTable is MateConfListenersPrivate, but shorter */
...
static void
notify_listener_list(MateConfListeners* listeners,
                     GList* list,
                     const gchar* key,
                     MateConfListenersCallback callback,
                     gpointer user_data)
