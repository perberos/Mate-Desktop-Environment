 ...
 */
#ifndef _MATECOMPONENT_MACROS_H_
#define _MATECOMPONENT_MACROS_H_
...
#define MATECOMPONENT_BOILERPLATE(type, type_as_function, corba_type,		\
...
#define MATECOMPONENT_CALL_PARENT(parent_class_cast, name, args)		\
	((parent_class_cast(parent_class)->name != NULL) ?		\
	 parent_class_cast(parent_class)->name args : (void)0)

/* Same as above, but in case there is no implementation, it evaluates
 * to def_return */
#define MATECOMPONENT_CALL_PARENT_WITH_DEFAULT(parent_class_cast,		\
					name, args, def_return)		\
	((parent_class_cast(parent_class)->name != NULL) ?		\
	 parent_class_cast(parent_class)->name args : def_return)


#define MATECOMPONENT_CLASS_BOILERPLATE(type, type_as_function,		\
				 parent_type, parent_type_macro)	\
	MATECOMPONENT_BOILERPLATE(type, type_as_function, type,		\
			   parent_type, parent_type_macro,		\
			   MATECOMPONENT_REGISTER_TYPE)
#define MATECOMPONENT_REGISTER_TYPE(type, type_as_function, corba_type,	\
			     parent_type, parent_type_macro)		\
	matecomponent_type_unique (parent_type_macro, NULL, NULL, 0,		\
			    &object_info, #type)

#define MATECOMPONENT_CLASS_BOILERPLATE_FULL(type, type_as_function,		\
				      corba_type,			\
				      parent_type, parent_type_macro)	\
	MATECOMPONENT_BOILERPLATE(type, type_as_function, corba_type,		\
			   parent_type, parent_type_macro,		\
			   MATECOMPONENT_REGISTER_TYPE_FULL)
#define MATECOMPONENT_REGISTER_TYPE_FULL(type, type_as_function, corba_type,	\
				  parent_type, parent_type_macro)	\
	matecomponent_type_unique (parent_type_macro,				\
