			   ...
			   GtkWidget *previous_parent)
{
	...
	if (menubar->priv->applications_menu)
		mate_panel_applet_menu_set_recurse (GTK_MENU (menubar->priv->applications_menu),
					       "menu_panel",
					       menubar->priv->panel);
		     ...
		     const char  *id)
{
	...
	menubar->priv->info = mate_panel_applet_register (
...
void
panel_menu_bar_load_from_mateconf (PanelWidget *panel,
				gboolean     locked,
				int          position,
				gboolean     exactpos,
				const char  *id)
