...
static const GtkActionEntry directory_view_entries[] =
{
    ...
    /* name, stock id */         {
        FM_ACTION_LOCATION_OPEN_ALTERNATE, NULL,
    ...
    /* name, stock id */         {
        FM_ACTION_LOCATION_OPEN_IN_NEW_TAB, NULL,
    ...
    /* name, stock id */         {
        FM_ACTION_LOCATION_OPEN_FOLDER_WINDOW, NULL,
    ...
    /* name, stock id */         {
        FM_ACTION_LOCATION_CUT, GTK_STOCK_CUT,
    ...
    /* name, stock id */         {
        FM_ACTION_LOCATION_RESTORE_FROM_TRASH, NULL,
