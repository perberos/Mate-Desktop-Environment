...
gkbd_preview_save_position (GdkRectangle * rect)
{
	...
	mateconf_change_set_set_int (cs, GKBD_PREVIEW_CONFIG_KEY_X, rect->x);
	mateconf_change_set_set_int (cs, GKBD_PREVIEW_CONFIG_KEY_Y, rect->y);
	mateconf_change_set_set_int (cs, GKBD_PREVIEW_CONFIG_KEY_WIDTH,
				  rect->width);
	mateconf_change_set_set_int (cs, GKBD_PREVIEW_CONFIG_KEY_HEIGHT,
				  rect->height);
